            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-[24px] p-8 sm:p-[80px]">
              ...
              <div className="text-lg">
                <div className="prose prose-gray max-w-none">
                  <p className="text-stone-700 leading-normal mb-6">
                    Acredito que o processo terapêutico é sobre criar espaço para se escutar com mais honestidade. Um caminho de reconexão com a sua história, com o que você sente e com o que realmente importa — no seu ritmo.
                  </p>
                  <p className="text-stone-700 leading-normal mb-6">
                    Neste momento, atuo exclusivamente com mulheres, oferecendo atendimentos online, especialmente para aquelas que estão:
                  </p>
                  <ul className="text-stone-700 leading-normal mb-6 list-disc pl-6 space-y-1">
                    <li>Explorando o desejo de ser mae — ou de não seguir esse caminho</li>
                    <li>Reavaliando relações, papéis e vínculos afetivos</li>
                    <li>Buscando mais autenticidade na forma como vivem e se relacionam</li>
                    <li>Morando fora do seu país e atravessando as dores (e transformações) de recomeçar em um novo lugar</li>
                    <li>Desejando se libertar de expectativas e narrativas que já não fazem sentido.</li>
                  </ul>
                  
                  <h3 className="text-[24px] text-stone-800 leading-normal mb-6 font-bold mt-8">
                    Minha formação
                  </h3>
                  <p className="text-stone-700 leading-normal mb-6">
                  ...
                  <p className="text-stone-800 leading-normal font-bold mb-2">
                  ...
                  <p className="text-stone-700 leading-normal mb-12">
              ...
              <div className="space-y-3 mt-8 flex flex-col items-center w-full mb-12">
                <Button 
                  variant="outline" 
                  className="w-full h-[50px] text-[19px] font-normal border border-gray-200 hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 flex items-center justify-center shadow-none"
               ...
               <p className="text-stone-500 leading-normal text-base mb-12">
                    <em>As consultas acontecem por videochamada, via Google Meet ou WhatsApp. Os pagamentos podem ser feitos por Pix ou PayPal.</em>
                  </p>
            </div>
          </div>
        </div>
